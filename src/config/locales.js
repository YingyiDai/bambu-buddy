...
const STRINGS = {
  'zh-CN': {
    ...
    'settings.labelPreview': '效果预览',
    'settings.labelContent': '显示内容',
    'settings.labelChipLayer': '层数',
    'settings.labelChipTime': '剩余时间',
    'settings.labelChipFinish': '完成时间',
    'settings.labelScroll': '文案放不下时',
    'settings.labelScrollHover': '鼠标悬停时滚动',
    'settings.labelScrollAuto': '自动滚动',
  ...
  'en': {
    ...
    'settings.labelPreview': 'Live Preview',
    'settings.labelContent': 'Show',
    'settings.labelChipLayer': 'Layers',
    'settings.labelChipTime': 'Time Left',
    'settings.labelChipFinish': 'Done At',
    'settings.labelScroll': 'When Text Overflows',
    'settings.labelScrollHover': 'Scroll on hover',
    'settings.labelScrollAuto': 'Scroll always',
