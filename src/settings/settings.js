...
// Google 官方四色 G、Facebook 自带蓝色圆标——本就是圆形，保持原样。
// 唯 Apple 是光秃剪影，给它加一个圆形底板补成圆形，与另两个齐整：
// 底板 var(--text)、苹果取卡片底色 var(--panel)，故浅色＝黑底白果、深色自动反转
//（即「Sign in with Apple」按钮的深浅两态），两主题都清晰。
...
// viewBox 收成以苹果实际包围盒中心(11.77,11.80)为中心的正方形——原 0 0 24 24 下
// 苹果偏左下、在圆里不居中（实测 bbox 中心非 12,12）。此 viewBox 让其几何居中。
const APPLE_ICON = '<span class="ac-apple" role="img" aria-label="Apple"><svg class="ac-apple-glyph" viewBox="0.27 0.30 23 23" aria-hidden="true"><path d="M17.05 12.53c-.03-2.42 1.98-3.58 2.07-3.64-1.13-1.65-2.89-1.88-3.51-1.9-1.49-.15-2.91.88-3.67.88-.76 0-1.93-.86-3.17-.83-1.63.02-3.13.95-3.97 2.41-1.69 2.94-.43 7.29 1.21 9.68.8 1.17 1.76 2.48 3.01 2.43 1.21-.05 1.67-.78 3.13-.78 1.46 0 1.87.78 3.15.75 1.3-.02 2.12-1.19 2.92-2.36.92-1.35 1.3-2.66 1.32-2.73-.03-.01-2.53-.97-2.56-3.86zM14.62 5.09c.67-.81 1.12-1.94.99-3.06-.96.04-2.13.64-2.82 1.45-.62.72-1.16 1.87-1.02 2.97 1.07.08 2.17-.54 2.85-1.36z"/></svg></span>';
