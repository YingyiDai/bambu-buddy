...
// 唯 Apple 是光秃剪影，做成一整个 SVG（圆底 + 苹果同在一个图里，与 Facebook 同构），
// 补成圆形。底板 var(--text)、苹果取卡片底色 var(--panel)，故浅色＝黑底白果、深色自动
// 反转（即「Sign in with Apple」按钮的深浅两态），两主题都清晰。
